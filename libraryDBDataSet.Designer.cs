...
namespace LibraryDB.libraryDBDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Books] WHERE (([ID] = @Original_ID) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_YearPublished = 1 AND [YearPublished] IS NULL) OR ([YearPublished] = @Original_YearPublished)) AND ((@IsNull_Genre = 1 AND [Genre] IS NULL) OR ([Genre] = @Original_Genre)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [Title] = @Title, [Author] = @Author, [YearPublished] = @YearPublished, [Genre] = @Genre WHERE (([ID] = @Original_ID) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_YearPublished = 1 AND [YearPublished] IS NULL) OR ([YearPublished] = @Original_YearPublished)) AND ((@IsNull_Genre = 1 AND [Genre] IS NULL) OR ([Genre] = @Original_Genre)));
SELECT ID, Title, Author, YearPublished, Genre FROM Books WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LibraryDB.Properties.Settings.Default.libraryDBConnectionString;
        }
        ...
        public virtual int Delete(int Original_ID, string Original_Title, string Original_Author, global::System.Nullable<int> Original_YearPublished, string Original_Genre) {
            ...
            if ((Original_YearPublished.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((int)(Original_YearPublished.Value));
            }
            else {
        ...
        public virtual int Insert(string Title, string Author, global::System.Nullable<int> YearPublished, string Genre) {
            if ((Title == null)) {
            ...
            if ((YearPublished.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[2].Value = ((int)(YearPublished.Value));
            }
            else {
        ...
        public virtual int Update(string Title, string Author, global::System.Nullable<int> YearPublished, string Genre, int Original_ID, string Original_Title, string Original_Author, global::System.Nullable<int> Original_YearPublished, string Original_Genre, int ID) {
            if ((Title == null)) {
            ...
            if ((YearPublished.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(YearPublished.Value));
            }
            else {
            ...
            if ((Original_YearPublished.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_YearPublished.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Author, global::System.Nullable<int> YearPublished, string Genre, int Original_ID, string Original_Title, string Original_Author, global::System.Nullable<int> Original_YearPublished, string Original_Genre) {
